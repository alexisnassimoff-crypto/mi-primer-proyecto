...
Genera intros/dialogos del personaje (ej. "Hi, I'm Suki! Let's glow!"). No es necesario
...
def generate_voice(song_id: str, text: str, voice_id: str = "suki_warm") -> Path | None:
    if not text:
        return None
